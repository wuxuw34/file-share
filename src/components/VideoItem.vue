...
onMounted(() => {
    videoRef.value!.srcObject = props.stream
    const info = getVideoInfo(props.stream)
    if (info) {
        vidoeInfo.value.frameRate = info.frameRate!
        vidoeInfo.value.height = info.height!
        vidoeInfo.value.width = info.width!
    }
})
...
<template>
    <div class="video-item" @click="stopPropagation">
        ...
        <div>
            ...
            <div class="opearate">
                <div>
                    <div class="desc">{{ vidoeInfo.width }} x {{ vidoeInfo.height }}</div>
                    <div class="desc">{{ vidoeInfo.frameRate }}</div>
